...
export function Finance() {
  ...
  return (
    <section id="finance" className="relative border-y border-gold/20 bg-pitch-2 py-20 md:py-28">
      <div className="mx-auto max-w-[1500px] px-4 md:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
          <div>
            ...
            <div className="mt-10 grid grid-cols-2 gap-4 border-t border-cream/12 pt-8">
              <div>
          ...
          <Reveal className="grid gap-px bg-gold/22 sm:grid-cols-2">
            {content.services.items.map((item, i) => (
              <div key={item.title} className="h-full bg-pitch-2 p-6 md:p-8">
